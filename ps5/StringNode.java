...
public class StringNode {
    ...
    public static StringNode copy(StringNode str) {
        ...
        while (trav.next != null) {
            nextNode = new StringNode(trav.next.ch, null);
            prevNode.next = nextNode;
            prevNode = nextNode;
            trav = trav.next;
        }
                                         ...
                                         char beforeChar) 
    {
        ...
        if (trav == null) {
            return newNode;
        } else if (trav.ch == beforeChar) {
            newNode.next = str;
            return newNode;
        } else if (trav.next == null && trav.ch != beforeChar) {
            trav.next = newNode;
            return str;
        } else {
            trav.next = insertBefore(trav.next, newChar, beforeChar);
            return str;
        }
    }
    ...
    /*
     * length -  determines the number of characters in the
     * linked-list string to which str refers using iteration
     */
    ...
    public static void toUpperCase(StringNode str) { 
        ...
        if (trav == null) {
            ...
            toUpperCase(trav.next);
        }
        /*StringNode upperCase = new StringNode(str.ch, null);
        upperCase = upperCase.toUpperCase(str.next); */
        /*
        StringNode trav = str; 
        while (trav != null) {
            trav.ch = Character.toUpperCase(trav.ch); 
