...
public class LinkedTree {
    ...
    private class InorderIterator implements LinkedTreeIterator {
        ...
        /*
         * hasNext()- returns true if the next node is not null
        ...
        /*
         * next() - returns the value of the key in the next node to be visited
         * and advances the iterator to the next call
         */
        public int next() {
            if (nextNode == null) {
    ...
    /*
     * inorderIterator() - creates and returns an instance of the class InorderIterator
     */
    ...
    public void insert(int key, Object data) {
        ...
        newNode.parent = parent; // NUMBER 1 
    }
    ...
    public static void main(String[] args) {
        ...
        LinkedTree treeA = new LinkedTree();
        int[] keys = {37, 26, 42, 13, 35, 56, 30, 47, 70};
        treeA.insertKeys(keys);
        treeA.inorderPrint();

        LinkedTree treeB = new LinkedTree();
        int[] keys2 = {20, 10, 25, 5, 12, 22, 30};
        treeB.insertKeys(keys2);
        treeB.inorderPrint();
